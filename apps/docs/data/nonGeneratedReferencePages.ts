const nonGeneratedReferencePages = [
  ...
  'docs/reference/wechat',
  'docs/reference/wechat/installing',
  'docs/reference/wechat/release-notes',
  'docs/reference/wechat/upgrade-guide',
  'docs/reference/wechat/typescript-support',
  'docs/reference/api',
