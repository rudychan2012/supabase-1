module.exports = {
  brand: {
    brand1: 'hsla(23, 80%, 99%, 1)',
    brand2: 'hsla(18, 88%, 97%, 1)',
    brand3: 'hsla(18, 76%, 95%, 1)',
    brand4: 'hsla(18, 68%, 92%, 1)',
    brand5: 'hsla(18, 59%, 88%, 1)',
    brand6: 'hsla(19, 43%, 82%, 1)',
    brand7: 'hsla(19, 43%, 69%, 1)',
    brand8: 'hsla(15, 75%, 58%, 1)',
    brand9: 'hsla(15, 79%, 65%, 1)',
    brand10: 'hsla(23, 50%, 50%, 1)',
    brand11: 'hsla(23, 50%, 34%, 1)',
    brand12: 'hsla(23, 40%, 12%, 1)',
  },
  brandDark: {
