...
export const SQL_TEMPLATES: SQLTemplate[] = [
  {
    ...
    type: 'template',
    title: '创建表',
    description: '基本表格模板。将“table_name”更改为您喜欢的名称。',
...
-- const { data, error } = await supabase.rpc('increment', { row_id: 2 })
  ...
  },
  {
    ...
    description: '从 pg_stat_statements 中选择并查看最近的查询',
...
select
  ...
  },
  {
    ...
    type: 'quickstart',
    title: '国家',
    description: '创建一个包含世界上所有国家/地区的表格。',
...
`.trim(),
  },
  {
    ...
    type: 'quickstart',
    title: 'Slack Clone',
    description: '构建具有行级安全性的基本slack clone。',
    sql: `
--
...
`.trim(),
  },
  {
    ...
    type: 'quickstart',
    title: 'Todo List',
    description: '构建基本的具有行级安全策略的todo list。',
    sql: `
--
-- For use with:
...
`.trim(),
  },
  {
    ...
    description: 'Next.js Stripe Subscriptions Starter 的入门模板。',
    sql: `
/**
* USERS
...
`.trim(),
  },
  {
    ...
    type: 'quickstart',
    title: '用户管理',
    description: '配置一个公开的可以通过你的API访问的Profiles表。',
    sql: `
...
`.trim(),
  },
  {
    id: 15,
    type: 'quickstart',
    title: 'NextAuth Schema 设置',
    description: '为 NextAuth Supabase Adapter设置schema和表。',
    sql: `
--
